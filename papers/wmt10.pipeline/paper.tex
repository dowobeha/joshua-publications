...
Following \newcite{Joshua-WMT}, a subset of the available training sentences is selected via subsampling; training sentences are selected based on the estimated likelihood of that sentence being useful later for translating a particular test corpus. 
